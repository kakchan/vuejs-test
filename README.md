# VueJs Interview-Test

### Instructions

Please write a Vue typescript or javascript state managed app to display a table using this api endpoint https://jsonplaceholder.typicode.com/users. **The project should also include sufficient unit tests**.
